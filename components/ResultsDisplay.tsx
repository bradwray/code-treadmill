...
const Label = styled.span<{ bump: number }>`
  position: absolute;
  text-align: center;
...
const Line = styled.hr<{ bump: number | string }>`
  width: 377px;
  z-index: 0;
...
export default function ResultsDisplay(): React.ReactElement {
  ...
  return (
    <DisplayContainer>
      ...
      <Readouts>
        ...
        <DigitalReadOut value={store.score} label="score" measure="rpm * complex" />
      </Readouts>
    </DisplayContainer>
  );
}
